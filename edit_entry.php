...
function create_field_entry_start_date($disabled=FALSE)
{
  ...
  genSlotSelector($areas[$area_id], 'start_seconds', 'start_seconds', $current_s, FALSE, FALSE, TRUE);
  genAllDay($areas[$area_id], 'all_day', 'all_day', FALSE, FALSE);
...
function create_field_entry_end_date($disabled=FALSE)
{
  ...
  genSlotSelector($areas[$area_id], 'end_seconds', 'end_seconds', $this_current_s, FALSE, FALSE);
